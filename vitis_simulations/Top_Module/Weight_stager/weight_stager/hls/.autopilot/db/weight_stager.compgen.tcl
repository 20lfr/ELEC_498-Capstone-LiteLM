...
set name weight_stager_mul_32s_32s_32_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { wl_ready { O 1 vector } wl_ready_ap_vld { O 1 bit } } \
} "
}
