...
HLS_SOURCES = ../../../../../../../HLS-Verilog/Weight_Loader-Stager/Weight_stager_tb.cpp ../../../../../../../HLS-Verilog/Weight_Loader-Stager/Weight_stager.cpp
...
$(ObjDir)/Weight_stager_tb.o: ../../../../../../../HLS-Verilog/Weight_Loader-Stager/Weight_stager_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../../HLS-Verilog/Weight_Loader-Stager/Weight_stager_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/Weight_stager_tb.d
