...
HLS_SOURCES = ../../../../../../../HLS-Verilog/MMU/mmu_tb.cpp ../../../../../../../HLS-Verilog/MMU/mmu.cpp
...
$(ObjDir)/mmu_tb.o: ../../../../../../../HLS-Verilog/MMU/mmu_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../../HLS-Verilog/MMU/mmu_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/mmu_tb.d

$(ObjDir)/mmu.o: ../../../../../../../HLS-Verilog/MMU/mmu.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../../HLS-Verilog/MMU/mmu.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/mmu.d
