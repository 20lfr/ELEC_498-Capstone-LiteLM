...
# 4 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Scheduler_FSM/src-hls/Head_Helpers/../../../top_params.hpp" 2
# 124 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Scheduler_FSM/src-hls/Head_Helpers/../../../top_params.hpp"
 ...
 switch (phase) {
    case LnPhase::SUM: {
      if (!ln_started && compute_ready) {
        ...
        compute_start = 1;
        compute_op = pack_compute_op(ops[0], layer_idx, -1, -1);
        ln_started = true;
    ...
    case LnPhase::SUMSQ: {
      if (!ln_started && compute_ready) {
        ln_compute_done = false;
        compute_start = 1;
        compute_op = pack_compute_op(ops[1], layer_idx, -1, -1);
        ln_started = true;
      } else if (ln_started && ln_compute_done) {
        ln_started = false;
        ln_compute_done = false;
    ...
    case LnPhase::MEAN: {
      if (!ln_started && compute_ready) {
        ln_compute_done = false;
        compute_start = 1;
        compute_op = pack_compute_op(ops[2], layer_idx, -1, -1);
        ln_started = true;
      } else if (ln_started && ln_compute_done) {
        ln_started = false;
        ln_compute_done = false;
    ...
    case LnPhase::EYY: {
      if (!ln_started && compute_ready) {
        ln_compute_done = false;
        compute_start = 1;
        compute_op = pack_compute_op(ops[3], layer_idx, -1, -1);
        ln_started = true;
      } else if (ln_started && ln_compute_done) {
        ln_started = false;
        ln_compute_done = false;
    ...
    case LnPhase::VAR: {
      if (!ln_started && compute_ready) {
        ln_compute_done = false;
        compute_start = 1;
        compute_op = pack_compute_op(ops[4], layer_idx, -1, -1);
        ln_started = true;
      } else if (ln_started && ln_compute_done) {
        ln_started = false;
        ln_compute_done = false;
    ...
    case LnPhase::VAR_EPS: {
      if (!ln_started && compute_ready) {
        ln_compute_done = false;
        compute_start = 1;
        compute_op = pack_compute_op(ops[5], layer_idx, -1, -1);
        ln_started = true;
      } else if (ln_started && ln_compute_done) {
        ln_started = false;
        ln_compute_done = false;
    ...
    case LnPhase::INV_STD: {
      if (!ln_started && compute_ready) {
        ln_compute_done = false;
        compute_start = 1;
        compute_op = pack_compute_op(ops[6], layer_idx, -1, -1);
        ln_started = true;
      } else if (ln_started && ln_compute_done) {
        ln_started = false;
        ln_compute_done = false;
    ...
    case LnPhase::NORM: {
      if (!ln_started && compute_ready) {
        ln_compute_done = false;
        compute_start = 1;
        compute_op = pack_compute_op(ops[7], layer_idx, -1, -1);
        ln_started = true;
      } else if (ln_started && ln_compute_done) {
        ln_started = false;
        ln_compute_done = false;
    ...
    case LnPhase::SCALE: {
      if (!ln_started && compute_ready) {
        ln_compute_done = false;
        compute_start = 1;
        compute_op = pack_compute_op(ops[8], layer_idx, -1, -1);
        ln_started = true;
      } else if (ln_started && ln_compute_done) {
        ln_started = false;
        ln_compute_done = false;
    ...
    case LnPhase::SHIFT: {
      if (!ln_started && compute_ready) {
        ln_compute_done = false;
        compute_start = 1;
        compute_op = pack_compute_op(ops[9], layer_idx, -1, -1);
        ln_started = true;
      } else if (ln_started && ln_compute_done) {
        ln_started = false;
        ln_compute_done = false;
