...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler transformer_top_sparsemux_7_2_202_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_wl_head \
    op interface \
    ports { wl_head { O 2 vector } wl_head_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { wl_addr_sel { O 4 vector } wl_addr_sel_ap_vld { O 1 bit } } \
} "
}
