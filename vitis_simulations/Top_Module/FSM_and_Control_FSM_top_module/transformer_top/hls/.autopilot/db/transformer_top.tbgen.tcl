...
set portList { 
	...
	{ head_ctx_ref_0_i sc_in sc_lv 202 signal 10 } 
	{ head_ctx_ref_0_o sc_out sc_lv 202 signal 10 } 
	{ head_ctx_ref_0_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ head_ctx_ref_1_i sc_in sc_lv 202 signal 11 } 
	{ head_ctx_ref_1_o sc_out sc_lv 202 signal 11 } 
	{ head_ctx_ref_1_o_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ head_ctx_ref_2_i sc_in sc_lv 202 signal 12 } 
	{ head_ctx_ref_2_o sc_out sc_lv 202 signal 12 } 
	{ head_ctx_ref_2_o_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ head_ctx_ref_3_i sc_in sc_lv 202 signal 13 } 
	{ head_ctx_ref_3_o sc_out sc_lv 202 signal 13 } 
	...
	{ dbg_ctrl_mem sc_out sc_lv 1056 signal 26 } 
	{ dbg_ctrl_mem_ap_vld sc_out sc_logic 1 outvld 26 } 
...
set ArgLastReadFirstWriteLatency {
	transformer_top {
		...
		memory_request {Type O LastRead -1 FirstWrite 2}
		...
		irq_ps {Type O LastRead -1 FirstWrite 3}
		dbg_state {Type O LastRead -1 FirstWrite 2}
		dbg_ctrl_mem {Type O LastRead -1 FirstWrite 3}
		...
		dbg_wl_start {Type O LastRead -1 FirstWrite 3}
		dbg_wl_addr_sel {Type O LastRead -1 FirstWrite 3}
		dbg_wl_layer {Type O LastRead -1 FirstWrite 3}
		dbg_wl_head {Type O LastRead -1 FirstWrite 3}
		dbg_wl_tile {Type O LastRead -1 FirstWrite 3}
		dbg_done {Type O LastRead -1 FirstWrite 2}
		dbg_error {Type O LastRead -1 FirstWrite 3}
