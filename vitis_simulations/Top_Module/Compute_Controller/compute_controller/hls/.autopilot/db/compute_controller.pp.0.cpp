# 1 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/compute_controller.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/compute_controller.cpp" 2
# 1 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/compute_controller.hpp" 1


# 1 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/../../top_params.hpp" 1
...
# 3 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/../../top_params.hpp" 2
...
# 4 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/../../top_params.hpp" 2
# 124 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/../../top_params.hpp"
...
# 329 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/../../top_params.hpp"
...
# 2 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/compute_controller.cpp" 2
...
#pragma HLS reset variable = busy
 ...
 ready = (!busy) && (!start);
    ...
    if (do_compute) {
        VITIS_LOOP_40_1: for (int out = 0; out < ACCUM_MAX; ++out) {
#pragma HLS UNROLL factor=MAC_OUT_UNROLL
 int32_t acc = static_cast<int32_t>(bias[out]);
            VITIS_LOOP_43_2: for (int i = 0; i < VECTOR_MAX; ++i) {
...
# 61 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/compute_controller.cpp"
...
void FFN_PRE_ACT(
    ...
    const int4_t weights[D_MODEL * D_TILE_W1],
    const int4_t bias[D_TILE_W1],
    const int16_t scale[D_TILE_W1],
    int16_t output[D_TILE_W1]
) {
...
void FFN_POST_ACT(
    const int16_t input[D_FFN],
    const int4_t weights[D_FFN * D_TILE_W2],
    const int4_t bias[D_TILE_W2],
    const int16_t scale[D_TILE_W2],
...
#pragma HLS ARRAY_PARTITION variable=out cyclic factor=MAC_OUT_UNROLL dim=1
 bool mac_start = false;
    ...
    if (reset) {
        ...
        VITIS_LOOP_286_1: for (int i = 0; i < VECTOR_MAX; ++i) {
#pragma HLS UNROLL
 vectorA[i] = 0;
        }
        VITIS_LOOP_290_2: for (int i = 0; i < MATRIX_MAX; ++i) {
#pragma HLS UNROLL
 matrixB[i] = 0;
        }
        VITIS_LOOP_294_3: for (int i = 0; i < ACCUM_MAX; ++i) {
#pragma HLS UNROLL
 bias[i] = 0;
        }
