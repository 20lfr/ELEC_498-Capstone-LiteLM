...
__attribute__((sdx_kernel("compute_controller", 0))) void compute_controller(
    ...
    int4_t valueB[D_MODEL * D_TILE_WO],
...
#pragma HLS INLINE off
 VITIS_LOOP_31_1: for (int t = 0; t < D_TILE_WO; ++t) {
#pragma HLS UNROLL
 int32_t acc = 0;
        VITIS_LOOP_34_2: for (int i = 0; i < D_MODEL; ++i) {
#pragma HLS UNROLL
...
__attribute__((sdx_kernel("compute_controller", 0))) void compute_controller(
    ...
    int8_t OUT_PROJ_valueA[D_MODEL],
...
# 68 "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/HLS-Verilog/Transformer_logic/src-hls/compute_controller.cpp"
