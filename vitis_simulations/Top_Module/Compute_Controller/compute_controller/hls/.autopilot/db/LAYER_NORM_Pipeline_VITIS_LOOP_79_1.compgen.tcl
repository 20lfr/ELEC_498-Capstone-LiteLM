...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler compute_controller_mac_muladd_8s_8s_19s_19_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { int8_activation_address0 { O 3 vector } int8_activation_ce0 { O 1 bit } int8_activation_q0 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sum_out \
    op interface \
    ports { sum_out { O 11 vector } sum_out_ap_vld { O 1 bit } } \
} "
}
