...
define void @apatb_compute_controller_ir(i1 zeroext %reset, i1 zeroext %compute_start, i32 %compute_instruction, i1* noalias nocapture nonnull dereferenceable(1) %compute_ready, i1* noalias nocapture nonnull dereferenceable(1) %compute_done, i1 zeroext %mem_transfer_done, i1* noalias nocapture nonnull dereferenceable(1) %mem_read_request, i1* noalias nocapture nonnull dereferenceable(1) %mem_write_request, i32* noalias nocapture nonnull dereferenceable(4) %mem_op, i8* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="4920" %in_buf, i8* noalias nocapture nonnull "fpga.decayed.dim.hint"="768" %out_buf, i8* noalias nocapture nonnull dereferenceable(1) %dbg_state, i32* noalias nocapture nonnull dereferenceable(4) %dbg_req_instruction, i8* noalias nocapture nonnull dereferenceable(1) %dbg_req_op, i8* noalias nocapture nonnull dereferenceable(1) %dbg_req_layer, i8* noalias nocapture nonnull dereferenceable(1) %dbg_req_head, i8* noalias nocapture nonnull dereferenceable(1) %dbg_req_tile, i1* noalias nocapture nonnull dereferenceable(1) %dbg_mac_start, i1* noalias nocapture nonnull dereferenceable(1) %dbg_mac_ready, i1* noalias nocapture nonnull dereferenceable(1) %dbg_mac_complete, i1* noalias nocapture nonnull dereferenceable(1) %error) local_unnamed_addr #0 {
entry:
  ...
  %0 = bitcast i8* %in_buf to [4920 x i8]*
  %1 = call i8* @malloc(i64 4920)
  %in_buf_copy = bitcast i8* %1 to [4920 x i8]*
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a4920i8([4920 x i8]* %11, [4920 x i8]* %10)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @onebyonecpy_hls.p0a4920i8([4920 x i8]* %dst, [4920 x i8]* readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [4920 x i8]* %dst, null
  %1 = icmp eq [4920 x i8]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a4920i8([4920 x i8]* nonnull %dst, [4920 x i8]* nonnull %src, i64 4920)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a4920i8([4920 x i8]* %dst, [4920 x i8]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [4920 x i8]* %src, null
  %1 = icmp eq [4920 x i8]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %dst.addr = getelementptr [4920 x i8], [4920 x i8]* %dst, i64 0, i64 %for.loop.idx2
  %src.addr = getelementptr [4920 x i8], [4920 x i8]* %src, i64 0, i64 %for.loop.idx2
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out(i1*, i1* readonly align 512, i1*, i1* readonly align 512, i1*, i1* readonly align 512, i1*, i1* readonly align 512, i32*, i32* readonly align 512, [4920 x i8]*, [4920 x i8]* readonly, [768 x i8]*, [768 x i8]* readonly align 512, i8*, i8* readonly align 512, i32*, i32* readonly align 512, i8*, i8* readonly align 512, i8*, i8* readonly align 512, i8*, i8* readonly align 512, i8*, i8* readonly align 512, i1*, i1* readonly align 512, i1*, i1* readonly align 512, i1*, i1* readonly align 512, i1*, i1* readonly align 512) unnamed_addr #4 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a4920i8([4920 x i8]* %10, [4920 x i8]* %11)
...
declare void @apatb_compute_controller_hw(i1, i1, i32, i1*, i1*, i1, i1*, i1*, i32*, [4920 x i8]*, [768 x i8]*, i8*, i32*, i8*, i8*, i8*, i8*, i1*, i1*, i1*, i1*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back(i1*, i1* readonly align 512, i1*, i1* readonly align 512, i1*, i1* readonly align 512, i1*, i1* readonly align 512, i32*, i32* readonly align 512, [4920 x i8]*, [4920 x i8]* readonly, [768 x i8]*, [768 x i8]* readonly align 512, i8*, i8* readonly align 512, i32*, i32* readonly align 512, i8*, i8* readonly align 512, i8*, i8* readonly align 512, i8*, i8* readonly align 512, i8*, i8* readonly align 512, i1*, i1* readonly align 512, i1*, i1* readonly align 512, i1*, i1* readonly align 512, i1*, i1* readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0i1(i1* %0, i1* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0i1(i1* %2, i1* align 512 %3)
  call fastcc void @onebyonecpy_hls.p0i1(i1* %4, i1* align 512 %5)
...
define void @compute_controller_hw_stub_wrapper(i1, i1, i32, i1*, i1*, i1, i1*, i1*, i32*, [4920 x i8]*, [768 x i8]*, i8*, i32*, i8*, i8*, i8*, i8*, i1*, i1*, i1*, i1*) #5 {
entry:
  call void @copy_out(i1* null, i1* %3, i1* null, i1* %4, i1* null, i1* %6, i1* null, i1* %7, i32* null, i32* %8, [4920 x i8]* null, [4920 x i8]* %9, [768 x i8]* null, [768 x i8]* %10, i8* null, i8* %11, i32* null, i32* %12, i8* null, i8* %13, i8* null, i8* %14, i8* null, i8* %15, i8* null, i8* %16, i1* null, i1* %17, i1* null, i1* %18, i1* null, i1* %19, i1* null, i1* %20)
  %21 = bitcast [4920 x i8]* %9 to i8*
  ...
  call void @copy_in(i1* null, i1* %3, i1* null, i1* %4, i1* null, i1* %6, i1* null, i1* %7, i32* null, i32* %8, [4920 x i8]* null, [4920 x i8]* %9, [768 x i8]* null, [768 x i8]* %10, i8* null, i8* %11, i32* null, i32* %12, i8* null, i8* %13, i8* null, i8* %14, i8* null, i8* %15, i8* null, i8* %16, i1* null, i1* %17, i1* null, i1* %18, i1* null, i1* %19, i1* null, i1* %20)
  ret void
}
