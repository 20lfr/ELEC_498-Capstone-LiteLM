set moduleName headed_compute_controller_Pipeline_VITIS_LOOP_622_26
set isTopModule 0
...
set cdfgNum 34
set C_modelName {headed_compute_controller_Pipeline_VITIS_LOOP_622_26}
...
dict set ap_memory_interface_dict soft_in { MEM_WIDTH 16 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ in_buf int 8 regular {array 80 { 1 1 } 1 1 }  }
	{ soft_in int 16 regular {array 16 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "in_buf", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "soft_in", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ soft_in_address0 sc_out sc_lv 4 signal 1 } 
	{ soft_in_ce0 sc_out sc_logic 1 signal 1 } 
	{ soft_in_we0 sc_out sc_logic 1 signal 1 } 
	{ soft_in_d0 sc_out sc_lv 16 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "soft_in_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "soft_in", "role": "we0" }} , 
 	{ "name": "soft_in_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "soft_in", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	soft_in { ap_memory {  { soft_in_address0 mem_address 1 4 }  { soft_in_ce0 mem_ce 1 1 }  { soft_in_we0 mem_we 1 1 }  { soft_in_d0 mem_din 1 16 } } }
}
