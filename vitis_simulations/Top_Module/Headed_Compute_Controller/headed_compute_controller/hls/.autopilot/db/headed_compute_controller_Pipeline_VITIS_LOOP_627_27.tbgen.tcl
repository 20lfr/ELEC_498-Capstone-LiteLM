set moduleName headed_compute_controller_Pipeline_VITIS_LOOP_627_27
set isTopModule 0
...
set cdfgNum 34
set C_modelName {headed_compute_controller_Pipeline_VITIS_LOOP_627_27}
...
dict set ap_memory_interface_dict soft_out { MEM_WIDTH 15 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ out_buf int 8 regular {array 64 { 0 0 } 0 1 }  }
	{ soft_out int 15 regular {array 16 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "out_buf", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "soft_out", "interface" : "memory", "bitwidth" : 15, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ soft_out_address0 sc_out sc_lv 4 signal 1 } 
	{ soft_out_ce0 sc_out sc_logic 1 signal 1 } 
	{ soft_out_q0 sc_in sc_lv 15 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "soft_out_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "soft_out", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	soft_out { ap_memory {  { soft_out_address0 mem_address 1 4 }  { soft_out_ce0 mem_ce 1 1 }  { soft_out_q0 mem_dout 0 15 } } }
}
