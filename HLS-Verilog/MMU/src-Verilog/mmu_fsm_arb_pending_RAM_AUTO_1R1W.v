...
(* DowngradeIPIdentifiedWarnings="yes" *) module mmu_fsm_arb_pending_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 1,
    AddressWidth = 5,
    AddressRange = 32
...
//------------------------Instantiation------------------
mmu_fsm_arb_pending_RAM_AUTO_1R1W_ram #(
    .DataWidth(DataWidth),
    .AddressWidth(AddressWidth),
    .AddressRange(AddressRange))
mmu_fsm_arb_pending_RAM_AUTO_1R1W_ram_u(
    .address0 ( address0 ),
    .ce0      ( ce0 ),
    .we0      ( we0 ),
    .d0       ( d0 ),
