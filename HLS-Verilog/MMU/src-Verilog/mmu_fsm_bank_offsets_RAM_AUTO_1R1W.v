...
(* DowngradeIPIdentifiedWarnings="yes" *) module mmu_fsm_bank_offsets_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 32,
    AddressWidth = 6,
    AddressRange = 64
...
//------------------------Instantiation------------------
mmu_fsm_bank_offsets_RAM_AUTO_1R1W_ram #(
    .DataWidth(DataWidth),
    .AddressWidth(AddressWidth),
    .AddressRange(AddressRange))
mmu_fsm_bank_offsets_RAM_AUTO_1R1W_ram_u(
    .address0 ( address0 ),
    .ce0      ( ce0 ),
    .we0      ( we0 ),
    .d0       ( d0 ),
