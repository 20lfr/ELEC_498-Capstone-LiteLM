...
static_assert((D_MODEL % NUM_WO_TILES) == 0, "D_MODEL must divide NUM_WO_TILES");
static_assert(((D_FFN * 2) % NUM_W1_TILES) == 0, "2*D_FFN must divide NUM_W1_TILES");
static_assert((D_MODEL % NUM_W2_TILES) == 0, "D_MODEL must divide NUM_W2_TILES");
