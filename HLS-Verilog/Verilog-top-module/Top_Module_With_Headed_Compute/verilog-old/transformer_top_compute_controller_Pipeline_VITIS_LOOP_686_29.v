...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_686_29 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln686_fu_75_p2 = (ap_sig_allocacmp_i_29 + 3'd1);
...
assign grp_read_i32_1_fu_54_byte_addr = $unsigned(sext_ln688_fu_109_p1);

assign icmp_ln686_fu_69_p2 = ((ap_sig_allocacmp_i_29 == 3'd4) ? 1'b1 : 1'b0);
...
assign or_ln_fu_100_p4 = {{{{1'd1}, {trunc_ln686_reg_153}}}, {2'd0}};

assign sext_ln688_fu_109_p1 = $signed(or_ln_fu_100_p4);

assign trunc_ln686_fu_81_p1 = ap_sig_allocacmp_i_29[1:0];

endmodule //transformer_top_compute_controller_Pipeline_VITIS_LOOP_686_29
