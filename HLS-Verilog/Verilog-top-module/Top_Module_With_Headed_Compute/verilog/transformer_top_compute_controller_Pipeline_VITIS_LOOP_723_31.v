...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_723_31 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln723_fu_173_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln766_fu_328_p1;
wire   [63:0] zext_ln767_fu_352_p1;
reg   [2:0] t_fu_100;
wire   [2:0] add_ln723_fu_179_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_t_12;
reg    out_buf_we1_local;
wire   [7:0] trunc_ln766_fu_323_p1;
...
wire   [46:0] select_ln727_fu_237_p3;
wire  signed [46:0] sext_ln724_fu_225_p1;
wire   [46:0] rounded_fu_245_p2;
wire   [16:0] tmp_185_fu_261_p4;
wire   [31:0] scaled_fu_251_p4;
wire   [0:0] icmp_ln729_fu_271_p2;
wire   [0:0] icmp_ln731_fu_277_p2;
wire   [0:0] or_ln734_fu_301_p2;
wire   [15:0] select_ln734_fu_293_p3;
wire   [15:0] trunc_ln_fu_283_p4;
wire   [15:0] v_fu_307_p3;
wire   [3:0] byte_addr_assign_s_fu_315_p3;
wire   [3:0] or_ln767_4_fu_344_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln723_fu_173_p2 == 1'd0)) begin
            t_fu_100 <= add_ln723_fu_179_p2;
...
always @ (*) begin
    if (((icmp_ln723_fu_173_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln723_fu_173_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln723_fu_179_p2 = (ap_sig_allocacmp_t_12 + 3'd1);
...
assign icmp_ln723_fu_173_p2 = ((ap_sig_allocacmp_t_12 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln729_fu_271_p2 = (($signed(tmp_185_fu_261_p4) > $signed(17'd0)) ? 1'b1 : 1'b0);

assign icmp_ln731_fu_277_p2 = (($signed(scaled_fu_251_p4) < $signed(32'd4294934528)) ? 1'b1 : 1'b0);

assign or_ln734_fu_301_p2 = (icmp_ln731_fu_277_p2 | icmp_ln729_fu_271_p2);

assign or_ln767_4_fu_344_p3 = {{ap_sig_allocacmp_t_12}, {1'd1}};

assign out_buf_address0 = zext_ln767_fu_352_p1;

assign out_buf_address1 = zext_ln766_fu_328_p1;
...
assign out_buf_d1 = trunc_ln766_fu_323_p1;
...
assign rounded_fu_245_p2 = ($signed(select_ln727_fu_237_p3) + $signed(sext_ln724_fu_225_p1));

assign scaled_fu_251_p4 = {{rounded_fu_245_p2[46:15]}};

assign select_ln727_fu_237_p3 = ((tmp_fu_229_p3[0:0] == 1'b1) ? 47'd140737488338944 : 47'd16384);

assign select_ln734_fu_293_p3 = ((icmp_ln729_fu_271_p2[0:0] == 1'b1) ? 16'd32767 : 16'd32768);

assign sext_ln724_fu_225_p1 = $signed(prod_fu_217_p3);

assign tmp_185_fu_261_p4 = {{rounded_fu_245_p2[46:30]}};

assign tmp_58_fu_185_p13 = 'bx;

assign tmp_fu_229_p3 = tmp_58_fu_185_p15[32'd31];

assign trunc_ln766_fu_323_p1 = v_fu_307_p3[7:0];

assign trunc_ln_fu_283_p4 = {{rounded_fu_245_p2[30:15]}};

assign v_fu_307_p3 = ((or_ln734_fu_301_p2[0:0] == 1'b1) ? select_ln734_fu_293_p3 : trunc_ln_fu_283_p4);

assign zext_ln766_fu_328_p1 = byte_addr_assign_s_fu_315_p3;

assign zext_ln767_fu_352_p1 = or_ln767_4_fu_344_p3;

endmodule //transformer_top_compute_controller_Pipeline_VITIS_LOOP_723_31
