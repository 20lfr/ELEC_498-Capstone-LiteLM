...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_617_18 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln617_fu_115_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln617_fu_103_p2 == 1'd0)) begin
            t_fu_54 <= add_ln617_fu_109_p2;
...
always @ (*) begin
    if (((icmp_ln617_fu_103_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln617_fu_103_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln617_fu_109_p2 = (ap_sig_allocacmp_t_13 + 3'd1);
...
assign out_buf_d0 = value_assign_6_fu_119_p11;

assign out_buf_we0 = out_buf_we0_local;

assign trunc_ln617_fu_115_p1 = ap_sig_allocacmp_t_13[1:0];
