...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_709_29 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln709_fu_77_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln709_fu_77_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_58 <= add_ln709_fu_83_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        icmp_ln709_reg_176 <= icmp_ln709_fu_77_p2;
    end
end

always @ (*) begin
    if (((icmp_ln709_reg_176 == 1'd1) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_subdone) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign add_ln709_fu_83_p2 = (ap_sig_allocacmp_i_28 + 3'd1);
...
assign grp_read_i32_fu_62_byte_addr = {{1'd1}, {zext_ln711_fu_101_p1}};

assign icmp_ln709_fu_77_p2 = ((ap_sig_allocacmp_i_28 == 3'd6) ? 1'b1 : 1'b0);
...
assign zext_ln711_fu_101_p1 = shl_ln8_fu_94_p3;

endmodule //transformer_top_compute_controller_Pipeline_VITIS_LOOP_709_29
