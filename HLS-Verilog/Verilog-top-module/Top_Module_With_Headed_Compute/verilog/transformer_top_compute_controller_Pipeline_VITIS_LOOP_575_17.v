...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_575_17 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln575_fu_38_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [0:0] icmp_ln577_fu_44_p2;
reg   [2:0] i_fu_26;
wire   [2:0] add_ln575_fu_62_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln575_fu_38_p2 == 1'd0)) begin
            i_fu_26 <= add_ln575_fu_62_p2;
...
always @ (*) begin
    if (((icmp_ln575_fu_38_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln577_fu_44_p2 == 1'd1) & (icmp_ln575_fu_38_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln577_fu_44_p2 == 1'd0) & (icmp_ln575_fu_38_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln575_fu_62_p2 = (ap_sig_allocacmp_i_36 + 3'd1);
...
assign icmp_ln575_fu_38_p2 = ((ap_sig_allocacmp_i_36 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln577_fu_44_p2 = ((ap_sig_allocacmp_i_36 == 3'd4) ? 1'b1 : 1'b0);

endmodule //transformer_top_compute_controller_Pipeline_VITIS_LOOP_575_17
