...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_574_17 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln574_fu_38_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [0:0] icmp_ln576_fu_44_p2;
reg   [2:0] i_fu_26;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln574_fu_38_p2 == 1'd0)) begin
            i_fu_26 <= add_ln574_fu_62_p2;
...
always @ (*) begin
    if (((icmp_ln574_fu_38_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
