...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_475_16 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln475_fu_75_p2 = (ap_sig_allocacmp_i_37 + 3'd1);
...
assign grp_read_i32_1_fu_54_byte_addr = $unsigned(sext_ln477_fu_109_p1);

assign icmp_ln475_fu_69_p2 = ((ap_sig_allocacmp_i_37 == 3'd4) ? 1'b1 : 1'b0);
...
assign or_ln_fu_100_p4 = {{{{1'd1}, {trunc_ln475_reg_153}}}, {2'd0}};

assign sext_ln477_fu_109_p1 = $signed(or_ln_fu_100_p4);

assign trunc_ln475_fu_81_p1 = ap_sig_allocacmp_i_37[1:0];

endmodule //transformer_top_compute_controller_Pipeline_VITIS_LOOP_475_16
