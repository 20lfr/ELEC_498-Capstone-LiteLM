...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_632_20 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln632_fu_223_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln748_fu_312_p1;
reg   [4:0] i_fu_102;
wire   [4:0] add_ln632_fu_229_p2;
wire    ap_loop_init;
...
wire   [3:0] trunc_ln632_fu_235_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln632_fu_223_p2 == 1'd0)) begin
            i_fu_102 <= add_ln632_fu_229_p2;
...
always @ (*) begin
    if (((icmp_ln632_fu_223_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln632_fu_223_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln632_fu_229_p2 = (ap_sig_allocacmp_i_36 + 5'd1);
...
assign icmp_ln632_fu_223_p2 = ((ap_sig_allocacmp_i_36 == 5'd16) ? 1'b1 : 1'b0);
...
assign trunc_ln632_fu_235_p1 = ap_sig_allocacmp_i_36[3:0];

assign value_assign_s_fu_239_p33 = 'bx;

assign zext_ln748_fu_312_p1 = trunc_ln632_fu_235_p1;

endmodule //transformer_top_compute_controller_Pipeline_VITIS_LOOP_632_20
