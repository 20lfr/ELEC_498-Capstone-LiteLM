...
wire   [6:0] add_ln565_fu_78_p2;
wire   [6:0] add_ln566_fu_89_p2;
wire   [6:0] add_ln567_fu_99_p2;
reg   [1:0] ap_NS_fsm;
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        in_buf_address0_local = zext_ln567_fu_104_p1;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        in_buf_address0_local = zext_ln565_fu_84_p1;
    end else begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        in_buf_address1_local = zext_ln566_fu_94_p1;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        in_buf_address1_local = zext_ln564_fu_73_p1;
    end else begin
...
assign add_ln565_fu_78_p2 = (byte_addr + 7'd1);

assign add_ln566_fu_89_p2 = (byte_addr_read_reg_119 + 7'd2);

assign add_ln567_fu_99_p2 = (byte_addr_read_reg_119 + 7'd3);
