...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_784_38 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln784_reg_157;
reg    ap_condition_exit_pp0_iter0_stage1;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [0:0] icmp_ln784_fu_71_p2;
wire    ap_block_pp0_stage0_11001;
wire   [1:0] trunc_ln784_fu_83_p1;
reg   [1:0] trunc_ln784_reg_161;
reg   [1:0] trunc_ln784_reg_161_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln784_fu_71_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln784_fu_71_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_52 <= add_ln784_fu_77_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln784_reg_157 <= icmp_ln784_fu_71_p2;
        trunc_ln784_reg_161 <= trunc_ln784_fu_83_p1;
        trunc_ln784_reg_161_pp0_iter1_reg <= trunc_ln784_reg_161;
    end
end

always @ (*) begin
    if (((icmp_ln784_reg_157 == 1'd1) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_subdone) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign or_ln_fu_113_p3 = {{1'd1}, {zext_ln786_fu_109_p1}};
...
endmodule //transformer_top_compute_controller_Pipeline_VITIS_LOOP_784_38
