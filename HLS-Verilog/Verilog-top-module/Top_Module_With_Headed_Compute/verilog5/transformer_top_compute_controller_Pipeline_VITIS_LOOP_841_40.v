...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_841_40 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln841_reg_157;
reg    ap_condition_exit_pp0_iter0_stage1;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [0:0] icmp_ln841_fu_71_p2;
wire    ap_block_pp0_stage0_11001;
wire   [1:0] trunc_ln841_fu_83_p1;
reg   [1:0] trunc_ln841_reg_161;
reg   [1:0] trunc_ln841_reg_161_pp0_iter1_reg;
...
reg   [2:0] i_fu_52;
wire   [2:0] add_ln841_fu_77_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_i_26;
wire    ap_block_pp0_stage0;
wire   [3:0] shl_ln8_fu_102_p3;
wire   [4:0] zext_ln843_fu_109_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln841_fu_71_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln841_fu_71_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_52 <= add_ln841_fu_77_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln841_reg_157 <= icmp_ln841_fu_71_p2;
        trunc_ln841_reg_161 <= trunc_ln841_fu_83_p1;
        trunc_ln841_reg_161_pp0_iter1_reg <= trunc_ln841_reg_161;
    end
end

always @ (*) begin
    if (((icmp_ln841_reg_157 == 1'd1) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_subdone) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((trunc_ln841_reg_161_pp0_iter1_reg == 2'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((trunc_ln841_reg_161_pp0_iter1_reg == 2'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((trunc_ln841_reg_161_pp0_iter1_reg == 2'd2) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((trunc_ln841_reg_161_pp0_iter1_reg == 2'd3) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign add_ln841_fu_77_p2 = (ap_sig_allocacmp_i_26 + 3'd1);
...
assign icmp_ln841_fu_71_p2 = ((ap_sig_allocacmp_i_26 == 3'd4) ? 1'b1 : 1'b0);
...
assign or_ln_fu_113_p3 = {{1'd1}, {zext_ln843_fu_109_p1}};

assign shl_ln8_fu_102_p3 = {{trunc_ln841_reg_161}, {2'd0}};

assign trunc_ln841_fu_83_p1 = ap_sig_allocacmp_i_26[1:0];

assign zext_ln843_fu_109_p1 = shl_ln8_fu_102_p3;

endmodule //transformer_top_compute_controller_Pipeline_VITIS_LOOP_841_40
