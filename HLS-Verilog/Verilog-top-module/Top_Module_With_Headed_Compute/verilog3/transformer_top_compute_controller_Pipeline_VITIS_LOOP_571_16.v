...
module transformer_top_compute_controller_Pipeline_VITIS_LOOP_571_16 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln571_reg_149;
reg    ap_condition_exit_pp0_iter0_stage1;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [0:0] icmp_ln571_fu_69_p2;
wire    ap_block_pp0_stage0_11001;
wire   [1:0] trunc_ln571_fu_81_p1;
reg   [1:0] trunc_ln571_reg_153;
reg   [1:0] trunc_ln571_reg_153_pp0_iter1_reg;
...
reg   [2:0] i_fu_50;
wire   [2:0] add_ln571_fu_75_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_i_37;
wire    ap_block_pp0_stage0;
wire   [4:0] or_ln_fu_100_p4;
wire  signed [5:0] sext_ln573_fu_109_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln571_fu_69_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln571_fu_69_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_50 <= add_ln571_fu_75_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln571_reg_149 <= icmp_ln571_fu_69_p2;
        trunc_ln571_reg_153 <= trunc_ln571_fu_81_p1;
        trunc_ln571_reg_153_pp0_iter1_reg <= trunc_ln571_reg_153;
    end
end

always @ (*) begin
    if (((icmp_ln571_reg_149 == 1'd1) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_subdone) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((trunc_ln571_reg_153_pp0_iter1_reg == 2'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((trunc_ln571_reg_153_pp0_iter1_reg == 2'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((trunc_ln571_reg_153_pp0_iter1_reg == 2'd2) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((trunc_ln571_reg_153_pp0_iter1_reg == 2'd3) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign add_ln571_fu_75_p2 = (ap_sig_allocacmp_i_37 + 3'd1);
...
assign grp_read_i32_fu_54_byte_addr = $unsigned(sext_ln573_fu_109_p1);

assign icmp_ln571_fu_69_p2 = ((ap_sig_allocacmp_i_37 == 3'd4) ? 1'b1 : 1'b0);
...
assign or_ln_fu_100_p4 = {{{{1'd1}, {trunc_ln571_reg_153}}}, {2'd0}};

assign sext_ln573_fu_109_p1 = $signed(or_ln_fu_100_p4);

assign trunc_ln571_fu_81_p1 = ap_sig_allocacmp_i_37[1:0];

endmodule //transformer_top_compute_controller_Pipeline_VITIS_LOOP_571_16
