...
module transformer_top_transformer_top_Pipeline_VITIS_LOOP_556_17 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_1_q0,
        ...
        transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_q0
);
...
input  [7:0] transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_1_q0;
...
input  [7:0] transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_q0;
...
wire   [0:0] icmp_ln556_fu_91_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg   [6:0] i_5_reg_147;
wire    ap_block_pp0_stage0_11001;
wire   [63:0] zext_ln556_1_fu_113_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln556_fu_124_p1;
reg   [6:0] i_fu_40;
wire   [6:0] add_ln556_fu_97_p2;
wire    ap_loop_init;
...
wire   [7:0] select_ln558_fu_131_p3;
reg    dbg_out_buf_ce0_local;
wire   [4:0] lshr_ln3_fu_103_p4;
wire   [0:0] trunc_ln556_fu_128_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln556_fu_91_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_40 <= add_ln556_fu_97_p2;
...
always @ (*) begin
    if (((icmp_ln556_fu_91_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln556_fu_97_p2 = (ap_sig_allocacmp_i_5 + 7'd1);
...
assign dbg_out_buf_address0 = zext_ln556_fu_124_p1;

assign dbg_out_buf_ce0 = dbg_out_buf_ce0_local;

assign dbg_out_buf_d0 = select_ln558_fu_131_p3;

assign dbg_out_buf_we0 = dbg_out_buf_we0_local;

assign icmp_ln556_fu_91_p2 = ((ap_sig_allocacmp_i_5 == 7'd64) ? 1'b1 : 1'b0);

assign lshr_ln3_fu_103_p4 = {{ap_sig_allocacmp_i_5[5:1]}};

assign select_ln558_fu_131_p3 = ((trunc_ln556_fu_128_p1[0:0] == 1'b1) ? transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_q0 : transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_1_q0);

assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_1_address0 = zext_ln556_1_fu_113_p1;
...
assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_address0 = zext_ln556_1_fu_113_p1;
...
assign trunc_ln556_fu_128_p1 = i_5_reg_147[0:0];

assign zext_ln556_1_fu_113_p1 = lshr_ln3_fu_103_p4;

assign zext_ln556_fu_124_p1 = i_5_reg_147;

endmodule //transformer_top_transformer_top_Pipeline_VITIS_LOOP_556_17
