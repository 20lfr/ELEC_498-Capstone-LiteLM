...
module transformer_top_transformer_top_Pipeline_VITIS_LOOP_298_10 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    if (((icmp_ln298_fu_70_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln298_fu_70_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign dma_rx_buf_local_address0 = zext_ln298_fu_82_p1;
...
assign dma_tx_buf_local_address0 = zext_ln298_fu_82_p1;
...
endmodule //transformer_top_transformer_top_Pipeline_VITIS_LOOP_298_10
