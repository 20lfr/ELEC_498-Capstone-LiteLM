...
module transformer_top_transformer_top_Pipeline_VITIS_LOOP_458_13 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln458_fu_60_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln458_fu_72_p1;
reg   [5:0] i_fu_28;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln458_fu_60_p2 == 1'd0)) begin
            i_fu_28 <= add_ln458_fu_66_p2;
...
always @ (*) begin
    if (((icmp_ln458_fu_60_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln458_fu_60_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign dma_rx_buf_local_address0 = zext_ln458_fu_72_p1;
