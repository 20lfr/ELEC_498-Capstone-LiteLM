...
module transformer_top_mmu_fsm_Pipeline_VITIS_LOOP_1475_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1475_fu_74_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln1475_fu_100_p1;
reg   [6:0] i_26_fu_34;
wire   [6:0] add_ln1475_fu_80_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_i;
reg    transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_1_we0_local;
wire   [0:0] trunc_ln1475_fu_86_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln1475_fu_74_p2 == 1'd0)) begin
            i_26_fu_34 <= add_ln1475_fu_80_p2;
...
always @ (*) begin
    if (((icmp_ln1475_fu_74_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((trunc_ln1475_fu_86_p1 == 1'd0) & (icmp_ln1475_fu_74_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((trunc_ln1475_fu_86_p1 == 1'd1) & (icmp_ln1475_fu_74_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln1475_fu_80_p2 = (ap_sig_allocacmp_i + 7'd1);
...
assign icmp_ln1475_fu_74_p2 = ((ap_sig_allocacmp_i == 7'd64) ? 1'b1 : 1'b0);

assign lshr_ln_fu_90_p4 = {{ap_sig_allocacmp_i[5:1]}};

assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_1_address0 = zext_ln1475_fu_100_p1;
...
assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_1_d0 = 8'd0;
...
assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_address0 = zext_ln1475_fu_100_p1;
...
assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_d0 = 8'd0;
...
assign trunc_ln1475_fu_86_p1 = ap_sig_allocacmp_i[0:0];

assign zext_ln1475_fu_100_p1 = lshr_ln_fu_90_p4;

endmodule //transformer_top_mmu_fsm_Pipeline_VITIS_LOOP_1475_1
