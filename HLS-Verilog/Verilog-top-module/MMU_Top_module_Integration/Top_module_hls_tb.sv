...
module top_module_hls_tb;
  ...
  localparam int CTRLW_WLOGIT_TILE_STRIDE = 21;
  localparam int CTRLW_LN0_GAMMA_STRIDE   = 22;
  localparam int CTRLW_LN1_GAMMA_STRIDE   = 23;
  localparam int CTRLW_FINAL_NORM_GAMMA_STRIDE = 24;
  localparam int CTRLW_LN0_EPS_STRIDE     = 25;
  localparam int CTRLW_LN1_EPS_STRIDE     = 26;
  localparam int CTRLW_FINAL_NORM_EPS_STRIDE = 27;
  localparam int CTRLW_WQ_BASE_LO         = 28;
  localparam int CTRLW_WQ_BASE_HI         = 28;
  localparam int CTRLW_WK_BASE_LO         = 29;
  localparam int CTRLW_WK_BASE_HI         = 29;
  localparam int CTRLW_WV_BASE_LO         = 30;
  localparam int CTRLW_WV_BASE_HI         = 30;
  localparam int CTRLW_WO_BASE_LO         = 31;
  localparam int CTRLW_WO_BASE_HI         = 31;
  localparam int CTRLW_W1_BASE_LO         = 32;
  localparam int CTRLW_W1_BASE_HI         = 32;
  localparam int CTRLW_W2_BASE_LO         = 33;
  localparam int CTRLW_W2_BASE_HI         = 33;
  localparam int CTRLW_K_CACHE_LO         = 34;
  ...
  localparam int CTRLW_W1_BIAS_BASE_HI    = 40;
  localparam int CTRLW_W2_BIAS_BASE_LO    = 41;
  localparam int CTRLW_W2_BIAS_BASE_HI    = 41;
  localparam int CTRLW_LN0_GAMMA_BASE_LO  = 42;
  localparam int CTRLW_LN0_GAMMA_BASE_HI  = 42;
  localparam int CTRLW_LN1_GAMMA_BASE_LO  = 43;
  localparam int CTRLW_LN1_GAMMA_BASE_HI  = 43;
  localparam int CTRLW_FINAL_NORM_GAMMA_BASE_LO = 44;
  localparam int CTRLW_FINAL_NORM_GAMMA_BASE_HI = 44;
  localparam int CTRLW_LN0_EPS_BASE_LO    = 45;
  localparam int CTRLW_LN0_EPS_BASE_HI    = 45;
  localparam int CTRLW_LN1_EPS_BASE_LO    = 46;
  localparam int CTRLW_LN1_EPS_BASE_HI    = 46;
  localparam int CTRLW_FINAL_NORM_EPS_BASE_LO = 47;
  ...
  always_ff @(posedge ap_clk) begin : axis_driver
    if (!ap_rst_n) begin
      ...
      if (!axis_packet_sent && !stream_fill_active &&
          (dbg_status_mem_shadow.status == 32'd1) &&
