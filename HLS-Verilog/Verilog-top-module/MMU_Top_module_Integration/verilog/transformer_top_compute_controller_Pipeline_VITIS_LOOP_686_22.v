...
wire   [2:0] lshr_ln794_4_fu_330_p4;
reg    ap_done_reg;
...
always @ (*) begin
    if (((trunc_ln794_fu_326_p1 == 1'd0) & (icmp_ln686_fu_236_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((trunc_ln794_fu_326_p1 == 1'd1) & (icmp_ln686_fu_236_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln686_fu_242_p2 = (ap_sig_allocacmp_i_74 + 5'd1);
...
assign icmp_ln686_fu_236_p2 = ((ap_sig_allocacmp_i_74 == 5'd16) ? 1'b1 : 1'b0);

assign lshr_ln794_4_fu_330_p4 = {{ap_sig_allocacmp_i_74[3:1]}};
...
assign trunc_ln794_fu_326_p1 = ap_sig_allocacmp_i_74[0:0];

assign value_assign_s_fu_252_p33 = 'bx;

assign value_assign_s_fu_252_p34 = ap_sig_allocacmp_i_74[3:0];

assign zext_ln794_fu_340_p1 = lshr_ln794_4_fu_330_p4;
