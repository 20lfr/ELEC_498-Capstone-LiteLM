...
module transformer_top_mmu_fsm_Pipeline_VITIS_LOOP_1714_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1714_fu_42_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [0:0] icmp_ln1715_fu_54_p2;
reg   [1:0] lane_fu_30;
wire   [1:0] add_ln1714_fu_48_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln1714_fu_42_p2 == 1'd0)) begin
            lane_fu_30 <= add_ln1714_fu_48_p2;
...
always @ (*) begin
    if (((icmp_ln1714_fu_42_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln1714_fu_48_p2 = (ap_sig_allocacmp_lane_5 + 2'd1);
...
assign icmp_ln1714_fu_42_p2 = ((ap_sig_allocacmp_lane_5 == 2'd2) ? 1'b1 : 1'b0);
