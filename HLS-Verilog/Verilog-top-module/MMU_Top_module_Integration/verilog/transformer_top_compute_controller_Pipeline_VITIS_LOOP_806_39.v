...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_sig_allocacmp_i_61 = 3'd4;
    end else begin
        ap_sig_allocacmp_i_61 = i_fu_26;
    end
end
...
assign add_ln806_fu_62_p2 = (ap_sig_allocacmp_i_61 + 3'd1);
...
assign icmp_ln806_fu_38_p2 = ((ap_sig_allocacmp_i_61 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln808_fu_44_p2 = ((ap_sig_allocacmp_i_61 == 3'd4) ? 1'b1 : 1'b0);
