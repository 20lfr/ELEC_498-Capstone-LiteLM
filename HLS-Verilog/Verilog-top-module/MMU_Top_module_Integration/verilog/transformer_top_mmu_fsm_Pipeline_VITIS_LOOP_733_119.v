...
module transformer_top_mmu_fsm_Pipeline_VITIS_LOOP_733_119 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [3:0] trunc_ln733_fu_93_p1;
reg   [3:0] trunc_ln733_reg_125;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln733_fu_97_p2;
reg   [0:0] icmp_ln733_reg_130;
wire   [4:0] add_ln733_fu_103_p2;
reg   [4:0] add_ln733_reg_134;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln733_reg_130 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        add_ln733_reg_134 <= add_ln733_fu_103_p2;
        icmp_ln733_reg_130 <= icmp_ln733_fu_97_p2;
        trunc_ln733_reg_125 <= trunc_ln733_fu_93_p1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((p_anonymous_namespace_regions_valid_q0_local == 1'd1) & (icmp_ln733_reg_130 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((icmp_ln733_reg_130 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
endmodule //transformer_top_mmu_fsm_Pipeline_VITIS_LOOP_733_119
