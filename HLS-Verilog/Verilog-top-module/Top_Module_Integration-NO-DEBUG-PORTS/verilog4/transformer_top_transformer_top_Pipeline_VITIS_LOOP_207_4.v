...
module transformer_top_transformer_top_Pipeline_VITIS_LOOP_207_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln207_fu_84_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln207_fu_110_p1;
reg   [6:0] i_2_fu_44;
wire   [6:0] add_ln207_fu_90_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_i;
reg    transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_5_we0_local;
wire   [0:0] trunc_ln207_fu_96_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln207_fu_84_p2 == 1'd0)) begin
            i_2_fu_44 <= add_ln207_fu_90_p2;
...
always @ (*) begin
    if (((icmp_ln207_fu_84_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((trunc_ln207_fu_96_p1 == 1'd1) & (icmp_ln207_fu_84_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((trunc_ln207_fu_96_p1 == 1'd0) & (icmp_ln207_fu_84_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln207_fu_90_p2 = (ap_sig_allocacmp_i + 7'd1);
...
assign icmp_ln207_fu_84_p2 = ((ap_sig_allocacmp_i == 7'd64) ? 1'b1 : 1'b0);

assign lshr_ln_fu_100_p4 = {{ap_sig_allocacmp_i[5:1]}};

assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_4_address0 = zext_ln207_fu_110_p1;
...
assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_5_address0 = zext_ln207_fu_110_p1;
...
assign trunc_ln207_fu_96_p1 = ap_sig_allocacmp_i[0:0];

assign zext_ln207_fu_110_p1 = lshr_ln_fu_100_p4;

endmodule //transformer_top_transformer_top_Pipeline_VITIS_LOOP_207_4
