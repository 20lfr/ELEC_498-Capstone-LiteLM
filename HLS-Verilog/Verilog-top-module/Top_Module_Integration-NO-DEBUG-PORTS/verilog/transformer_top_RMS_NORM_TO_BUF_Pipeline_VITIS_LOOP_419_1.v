...
module transformer_top_RMS_NORM_TO_BUF_Pipeline_VITIS_LOOP_419_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln419_fu_166_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [0:0] icmp_ln419_reg_322;
reg   [0:0] icmp_ln419_reg_322_pp0_iter1_reg;
reg   [0:0] icmp_ln419_reg_322_pp0_iter2_reg;
wire  signed [15:0] sext_ln422_fu_271_p1;
reg    ap_condition_exit_pp0_iter3_stage0;
wire   [63:0] zext_ln418_fu_202_p1;
wire    ap_block_pp0_stage0;
reg   [4:0] phi_urem_fu_64;
wire   [4:0] select_ln420_fu_231_p3;
wire    ap_loop_init;
reg   [19:0] square_fu_68;
wire  signed [19:0] grp_fu_292_p3;
reg  signed [19:0] ap_sig_allocacmp_square_2;
reg   [4:0] i_fu_72;
wire   [4:0] add_ln419_fu_172_p2;
...
wire   [3:0] trunc_ln418_fu_178_p1;
wire   [3:0] mul_ln418_fu_186_p0;
wire   [5:0] mul_ln418_fu_186_p1;
wire   [8:0] mul_ln418_fu_186_p2;
wire   [1:0] tmp_fu_192_p4;
wire   [0:0] icmp_ln420_fu_225_p2;
wire   [4:0] add_ln420_fu_219_p2;
...
transformer_top_mul_4ns_6ns_9_1_1 #(
    ...
    .din1_WIDTH( 6 ),
    .dout_WIDTH( 9 ))
mul_4ns_6ns_9_1_1_U303(
    .din0(mul_ln418_fu_186_p0),
    .din1(mul_ln418_fu_186_p1),
    .dout(mul_ln418_fu_186_p2)
);
...
transformer_top_mac_muladd_8s_8s_20s_20_4_1 #(
    ...
    .din2_WIDTH( 20 ),
    .dout_WIDTH( 20 ))
mac_muladd_8s_8s_20s_20_4_1_U305(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_292_p0),
    .din1(grp_fu_292_p1),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln419_fu_166_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_72 <= add_ln419_fu_172_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            phi_urem_fu_64 <= 5'd0;
        end else if (((icmp_ln419_reg_322 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            phi_urem_fu_64 <= select_ln420_fu_231_p3;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        icmp_ln419_reg_322 <= icmp_ln419_fu_166_p2;
        icmp_ln419_reg_322_pp0_iter1_reg <= icmp_ln419_reg_322;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        icmp_ln419_reg_322_pp0_iter2_reg <= icmp_ln419_reg_322_pp0_iter1_reg;
    end
end

always @ (*) begin
    if (((icmp_ln419_fu_166_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln419_reg_322_pp0_iter2_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln419_reg_322_pp0_iter2_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter3_reg == 1'b1))) begin
...
assign add_ln419_fu_172_p2 = (ap_sig_allocacmp_i_32 + 5'd1);

assign add_ln420_fu_219_p2 = (phi_urem_fu_64 + 5'd1);
...
assign grp_fu_292_p0 = sext_ln422_fu_271_p1;

assign grp_fu_292_p1 = sext_ln422_fu_271_p1;

assign icmp_ln419_fu_166_p2 = ((ap_sig_allocacmp_i_32 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln420_fu_225_p2 = ((phi_urem_fu_64 == 5'd4) ? 1'b1 : 1'b0);

assign mul_ln418_fu_186_p0 = mul_ln418_fu_186_p00;

assign mul_ln418_fu_186_p00 = trunc_ln418_fu_178_p1;

assign mul_ln418_fu_186_p1 = 9'd26;

assign select_ln420_fu_231_p3 = ((icmp_ln420_fu_225_p2[0:0] == 1'b1) ? 5'd0 : add_ln420_fu_219_p2);

assign sext_ln422_fu_271_p1 = $signed(x_fu_243_p13);

assign square_out = ap_sig_allocacmp_square_2[18:0];

assign tmp_fu_192_p4 = {{mul_ln418_fu_186_p2[8:7]}};

assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_4_address0 = zext_ln418_fu_202_p1;
...
assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_5_address0 = zext_ln418_fu_202_p1;
...
assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_6_address0 = zext_ln418_fu_202_p1;
...
assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_7_address0 = zext_ln418_fu_202_p1;
...
assign transformer_top_stream_stream_ap_uint_volatile_ControlMemSpace_StatusMemSpace_8_address0 = zext_ln418_fu_202_p1;
...
assign trunc_ln418_fu_178_p1 = ap_sig_allocacmp_i_32[3:0];

assign x_fu_243_p11 = 'bx;

assign x_fu_243_p12 = phi_urem_fu_64[2:0];

assign zext_ln418_fu_202_p1 = tmp_fu_192_p4;

endmodule //transformer_top_RMS_NORM_TO_BUF_Pipeline_VITIS_LOOP_419_1
