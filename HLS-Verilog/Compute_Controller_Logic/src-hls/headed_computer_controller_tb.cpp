...
static bool init_tb_logs() {
    ...
    const char *tb_dir = "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/logs/headed_compute_controller_tb";
    const char *stdout_path = "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/logs/headed_compute_controller_tb/headed_compute_controller_tb_stdout.log";
    const char *stderr_path = "/home/luka/Scripting/ELEC_498-Capstone-LiteLM/logs/headed_compute_controller_tb/headed_compute_controller_tb_stderr.log";
...
int main() {
    ...
    for (const HeadStep &step : steps) {
        ...
        for (int local = 0; local < 300; ++local, ++cycle) {
            ...
            const uint16_t token_pos = static_cast<uint16_t>((cycle < CONTEXT_LENGTH) ? cycle : (CONTEXT_LENGTH - 1));
