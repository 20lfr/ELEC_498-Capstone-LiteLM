...
def build_ctrl_words() -> list[int]:
    ...
    words[3] = 0x0000_1000  # layer stride
    words[4] = 0x0000_0100  # wq head stride
    words[5] = 0x0000_0100  # wk head stride
    words[6] = 0x0000_0100  # wv head stride
    words[7] = 0x0000_0100  # k cache stride
    words[8] = 0x0000_0100  # v cache stride
    words[9] = 0x0000_0020  # wo tile stride
    words[10] = 0x0000_0040  # w1 tile stride
    words[11] = 0x0000_0040  # w2 tile stride (>= W2 weight tile payload to avoid overlap)
    words[12] = 0x0000_0020  # wo bias tile stride
    words[13] = 0x0000_0040  # w1 bias tile stride
    words[14] = 0x0000_0020  # w2 bias tile stride
    words[15] = 0x0000_0080  # wlogit tile stride
    words[16] = 0x0000_0040  # ln0 gamma stride (per-layer full gamma vector)
    words[17] = 0x0000_0040  # ln1 gamma stride (per-layer full gamma vector)
    words[18] = 0x0000_0040  # final norm gamma stride (per-layer full gamma vector)
    words[19] = 0x0000_0004  # ln0 eps stride
    words[20] = 0x0000_0004  # ln1 eps stride
    words[21] = 0x0000_0004  # final norm eps stride
    words[22] = IMG_BASE_WQ
    words[23] = IMG_BASE_WK
    words[24] = IMG_BASE_WV
    words[25] = IMG_BASE_WO
    words[26] = IMG_BASE_W1
    words[27] = IMG_BASE_W2
    words[28] = IMG_BASE_K_CACHE
    words[29] = IMG_BASE_V_CACHE
    words[30] = IMG_BASE_WO_BIAS
    words[31] = IMG_BASE_W1_BIAS
    words[32] = IMG_BASE_W2_BIAS
    words[33] = IMG_BASE_LN0_GAMMA
    words[34] = IMG_BASE_LN1_GAMMA
    words[35] = IMG_BASE_FINAL_NORM_GAMMA
    words[36] = IMG_BASE_LN0_EPS
    words[37] = IMG_BASE_LN1_EPS
    words[38] = IMG_BASE_FINAL_NORM_EPS
    words[39] = IMG_BASE_WVOCAB  # wlogit offset
    return words
