...
// ---------------------------------------------------------------------------
// Select requant table version at compile time: -DREQUANT_SCALES_VER=N
// New versions are generated by:
//   python HLS-Verilog/test_data/gen_requant_scales.py --ln-shift <S>
// Default version 1 is the baseline generated from quant_scales.json.
...
#elif REQUANT_SCALES_VER == 4
#  include "requant_scales_v4.hpp"
#elif REQUANT_SCALES_VER == 5
#  include "requant_scales_v5.hpp"
#else
#  error "Unknown REQUANT_SCALES_VER — regenerate or add a new #elif above"
#endif
// ------------------------------------------------------------
