...
#define XAXI_TOP_CONTROL_BITS_CTRL_MEM_DATA   1280
#define XAXI_TOP_CONTROL_ADDR_CTRL_MEM_DATA_  0x38
#define XAXI_TOP_CONTROL_BITS_CTRL_MEM_DATA   1280
#define XAXI_TOP_CONTROL_ADDR_STATUS_MEM_DATA 0xb4
#define XAXI_TOP_CONTROL_BITS_STATUS_MEM_DATA 128
#define XAXI_TOP_CONTROL_ADDR_STATUS_MEM_CTRL 0xc4
